...
$.fn.viewSourceCode = function() {
	...
	return $( this ).each( function() {
		demoId++
		var button = $( "<div class='jqm-demo-link'><a href='#jqm-demo-" + demoId + "' data-rel='popup' data-role='button' data-icon='arrow-u' data-mini='true' data-inline='true' data-shadow='false'>Voir la source</a></div>" ),
		...
		if ( $( this ).is( "[data-demo-php]" ) ) {
			collapsiblePHP = $( "<div data-role='collapsible' data-collapsed='true' data-theme='g' data-iconpos='right' data-content-theme='a'>" +
					"<h1>PHP</h1>" +
					"<p class='phpStatus'>Chargement de la source PHP ...</p>" +
			...
			$.ajax( source )
				...
				.error( function() {
					...
					collapsiblePHP.find( ".phpStatus" ).html( "Echec pour charger la source PHP" );
				});

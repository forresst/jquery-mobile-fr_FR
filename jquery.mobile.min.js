/*! jQuery Mobile vGit Build: SHA1: 34c53b5fe74a4f1f30ecb434e2fc0c0ba183d204 <> Date: Fri Dec 16 11:53:49 2011 -0800 jquerymobile.com | jquery.org/license */
...
y="virtualTouchID",e="vmouseover vmousedown vmousemove vmouseup vclick vmouseout vmousecancel".split(" "),x="clientX clientY pageX pageY screenX screenY".split(" "),A=a.event.props.concat(a.event.mouseHooks.props),v={},u=0,s=0,D=0,t=false,z=[],B=false,w=false,C="addEventListener"in b,r=a(b),G=1,E=0;a.vmouse={moveDistanceThreshold:10,clickDistanceThreshold:10,resetTimerDuration:1500};for(var F=0;F<e.length;F++)a.event.special[e[F]]=q(e[F]);C&&b.addEventListener("click",function(b){var c=z.length,d=
b.target,f,r,e,g,j;if(c){f=b.clientX;r=b.clientY;threshold=a.vmouse.clickDistanceThreshold;for(e=d;e;){for(g=0;g<c;g++)if(j=z[g],e===d&&Math.abs(j.x-f)<threshold&&Math.abs(j.y-r)<threshold||a.data(e,y)===j.touchID){b.preventDefault();b.stopPropagation();return}e=e.parentNode}}},true)})(jQuery,window,document);

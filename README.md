...
jQuery Mobile 1.2 beta (1.2.0-rc.1) fonctionne avec les versions jQuery de la 1.6.4 à la 1.8.1. Vous pouvez trouver plus d'informations sur la façon dont la bibliothèque fonctionne et ce qu'elle est capable de faire par la lecture de la [documentation](http://mobile.jquery-fr.com/).
...
6. La version de jQuery Mobile et PhoneGap le cas échéant
7. Appareils/Navigateurs/plateformes testés

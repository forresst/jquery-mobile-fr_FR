...
jQuery Mobile 1.2 (1.2.0) fonctionne avec les versions jQuery de la 1.7.0 à la 1.8.2. Vous pouvez trouver plus d'informations sur la façon dont la bibliothèque fonctionne et ce qu'elle est capable de faire par la lecture de la [documentation](http://mobile.jquery-fr.com/).

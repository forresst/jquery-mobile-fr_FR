...
Une version compl̬te et une version minifi̩e du JavaScript de jQuery Mobile et des fichiers CSS seront cr̩̩s dans un dossier nomm̩
"compiled". Il y a aussi maintenant une structure seulement pour les fichiers css ainsi vous pouvez ajouter vos propres th̬mes.

Soumettre des bugs
==================
Si vous pensez que vous avez trouv̩ un bug, s'il vous pląt reportez le en suivant ces instructions :  
